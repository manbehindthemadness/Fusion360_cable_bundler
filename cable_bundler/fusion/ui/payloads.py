...
def _read_material_settings(raw_value: object) -> CableMaterialSettings:
    ...
    return CableMaterialSettings(
        ...
        dielectric_material=_read_material_text(
            {"dielectricMaterial": "", **raw_value},
            "dielectricMaterial",
            "Dielectric material",
            required=False,
        ),
...
def _read_harness_properties(
    raw_value: object,
) -> tuple[str, str, str, str, str, str, Metadata]:
    """
...
def _read_material_overrides(raw_value: object) -> CableMaterialOverrides:
    ...
    return CableMaterialOverrides(
        ...
        dielectric_material=optional_text("dielectricMaterial", "Dielectric material"),
...
def _read_visual_overrides(raw_value: object) -> CableVisualOverrides:
    ...
    return CableVisualOverrides(
        ...
        dielectric_material=(
            None
            if raw_value.get("dielectricMaterial") is None
            else _read_material_text(
                raw_value,
                "dielectricMaterial",
                "Dielectric material",
