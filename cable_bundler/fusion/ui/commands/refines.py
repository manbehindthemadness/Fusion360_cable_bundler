...
class _RefineExecuteHandler(adsk.core.CommandEventHandler):
    ...
    def notify(self, args: adsk.core.CommandEventArgs) -> None:
        """
        Insert the refine, synchronize occupied cables, and refresh the UI.
        """
...
class _RefineDestroyedHandler(adsk.core.CommandEventHandler):
    ...
    def notify(self, _args: adsk.core.CommandEventArgs) -> None:
        ...
        """
        try:
            restore_generated_cable_group_visibility(self._state.solid_visibility)
            application = adsk.core.Application.get()
            application.activeViewport.refresh()
        except (AttributeError, RuntimeError, TypeError, ValueError):
            _report_failure("restore generated cable solids after refine placement")
        finally:
...
class _RefineCreatedHandler(adsk.core.CommandCreatedEventHandler):
    ...
    def notify(self, args: adsk.core.CommandCreatedEventArgs) -> None:
        ...
        try:
            ...
            command_state.solid_visibility = hide_generated_cable_group_solids(
