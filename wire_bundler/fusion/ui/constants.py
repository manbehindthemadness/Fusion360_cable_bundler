...
PALETTE_RESOURCE_FILES = (
    ...
    ADDIN_ROOT / "palette" / "diagrams" / "create-wires" / "model.js",
    ADDIN_ROOT / "palette" / "diagrams" / "create-wires" / "view.js",
    ADDIN_ROOT / "palette" / "diagrams" / "create-wires" / "controller.js",
