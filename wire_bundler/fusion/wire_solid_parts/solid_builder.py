"""Build persistent Fusion sweep bodies for one routed wire group."""
...
from .constants import GENERATED_WIRE_GROUP_ATTRIBUTE
from .materials import material_metadata, wire_appearance
