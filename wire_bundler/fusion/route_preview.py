...
def show_route_previews(
    ...
    """
    routes, legs = solve_wire_group_routes(design, definition, notices)
...
def _refresh_wire_group_preview(
    ...
    try:
        routes, legs = solve_wire_group_routes(design, definition, solve_notices)
...
def solve_wire_group_centerlines(
    ...
    by the user.
    """
    return solve_wire_group_routes(design, definition, notices)
